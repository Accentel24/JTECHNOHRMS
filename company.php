...
include'dbfiles/iqry_company.php';
?>
<!DOCTYPE html>
<html lang="en">
                               ...
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
								   ...
								   <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="cname" name="cname" required placeholder="Enter Location Name"  /> 
                                   ...
                                   <!-- <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" id="billingto" name="billingto" required placeholder="Enter Billing Addresst"  ></textarea> 
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" id="shippingto" name="shippingto" required placeholder="Enter Billing Addresst"  ></textarea> 
...
<td class="center">
                                                        ...
                                                        <td>
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                <a href="edit_company.php?id=<?php echo $rs1['id']; ?>"  class="data green"  > <i class="ace-icon fa fa-pencil bigger-130"></i></a>
