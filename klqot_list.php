...
<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_klqot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_kl_excel.php" class="btn btn-primary btn-xs">XL Download</a></b></div>
...
<!--<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $store_code=trim($rs1['store_code']);
                                                ...
                                                if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='Sulfeekkar')){ ?>
                                          ...
                                          <?php }
                                                ...
                                                if($tsname=='admin'){ ?>
												   ...
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                         ...
                                                         <td class="hidden-480"><a href="klqut_excel.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                        <td class="hidden-480"><a href="klqut_excel_bill.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                     <td class="hidden-480"><a href="klqut_excel_mis.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                        <td class="hidden-480">
...
echo "<li><a href='klqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='klqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
