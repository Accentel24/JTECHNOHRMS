        ...
        <div class="main-container ace-save-state" id="main-container">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <form name="frm" method="post" action="tool_qot_suc.php" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" value="" name="supname" id="supname"></td>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        ...
                                                        <input id="inv_no" class="form-control" name="inv_no">
                                                    </td>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-offset-4 col-md-8">
                                                        ...
                                                        &nbsp; &nbsp; &nbsp;
                                                        <a href="ptoollist.php?state=<?php echo $state?>"><button class="btn btn-danger" type="button" name="button" id="Close">
            ...
            <script type="text/javascript">
                ...
                $(".addmore").on('click', function() {
                    ...
                    data += "<td>" + i + "</td>";
                    data += "<td><input type='hidden' name='id1[]'  id='id1" + i + "' style='width:200px;' data-row='" + i + "' value='<?php echo $id ?>'><input type='hidden' name='id5[]' id='id5" + i + "' style='width:200px;' data-row='" + i + "' value=''><input data-row='" + i + "' type='text' name='description[]' list=\'city1\' id='description" + i + "' style='width:200px;' value=''>";
                    data += "<datalist id=\'city1\'>";

                    data += '<?php
                                include_once("dbconnection/connection.php");
                                $sql = "select distinct tname from tool where state = '$state'"; 
