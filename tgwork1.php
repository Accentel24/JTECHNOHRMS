...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                     ...
                                     TG Mark Not Required Bills  List
                                        </div>
             ...
             <div class="col-sm-2"><b><a href="qut_tgmark_excel.php?user=<?php echo $tsname;?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
											...
											if(isset($_POST['bsearch'])){
											    $y="select * from tgrequest_amnt where req='yes' and docr_status!='Cancel'";
											 }else { 
												 $y="select * from tgrequest_amnt where req='yes' and docr_status!='Cancel'";
											...
											$yu=mysqli_query($link,"select * from add_tgqot where quet_num='$quet_num'") or die(mysqli_error($link));
...
<!--<td class="center">
                                                    ...
                                                    <td><?php echo $r3['superwisor']; ?> </td>
                                                     <td><?php 
                                                     $uy=mysqli_query($link,"select sum(approve_amnt) as amt from tgrequest_amnt where quet_num='$quet_num'") or die(mysqli_error($link));
                                                     ...
                                                     <th><?php echo $rs1['note']; ?></th>
                                                        ...
                                                        <td><a href="tgdcrfile_view.php?id=<?php echo $rs1['id'] ?>">View Fiie</a></td>
...
echo "<li><a href='tgwork1.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='tgwork1.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
