...
<div  style="margin-bottom:20px;">
    <?php if(($tsname=="9949342639") or ($tsname=="9959023441") or ($tsname=="9985894749") or ($tsname=="9502110504") or ($tsname=="9550717556") or ($tsname=="9052352111") or ($tsname=="9182349016") or ($tsname=="9908403960") or ($tsname=="9550100464") or ($tsname=="9618161227") or ($tsname=="8886931606")  or ($tsname=="9542485444") or ($tsname=="8096307371") or ($tsname=="9949576134")){}else{ ?>
...
<!--<td class="center">
                                                ...
                                                if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='rasheed')){ ?>
                                          ...
                                          <?php }
                                                ...
                                                ?>    
                                                        ...
                                                        <a href="editgrono_qot.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
                                                        ...
                                                        <?php }?>
														 ...
														 <td class="hidden-480"><a onclick="return confirm('Are you sure you want to send the Email?');" href="tgemail.php?id=<?php echo $rs1['id'];?>&name1=<?php echo $r1['coordinator'];?>&name2=<?php echo $r1['superwisor'];?>"
												   class="">
												   ...
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                         ...
                                                         <td class="hidden-480"><a href="tgqut_excel.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                        
                                                        <td class="hidden-480"><a href="tgqut_excel_bill.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                     <td class="hidden-480"><a href="tgqut_excel_mis.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                       </td>
