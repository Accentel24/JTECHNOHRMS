...
<html lang="en">
                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
							...
							<li>
                                ...
                                <a href="addtool.php">Tool Details</a>
                            </li>

                            <li>
                                <a href="edit_tool.php">Edit Tool Details</a>
                            </li>
 ...
 <?php
                      $id=$_REQUEST['id'];
                      $m=mysqli_query($link,"select * from tool where id='$id'") or die(mysqli_error($link));
                            ...
                            <div class="col-xs-12">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">Edit Tool Details</h3>
								</div>
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
									...
									<div class="box-body">
                                        ...
                                        <div class="col-sm-6">
                                           <input id=\"tcname\" list=\"city1\" class="form-control" name="tcname" value="<?php echo $str=$m1['tcname'];?>"  >
<datalist id=\"city1\" >

<?php 
include_once('dbconnection/connection.php');
$sql="select tcname from cattool";  // Query to collect records
...
echo "</datalist>";
include_once('dbconnection/connection.php');
$a="select * from tool where tcname='$str'";
...
?>
								   ...
								   <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="tname" name="tname" required placeholder="Name of the Tool" value="<?php echo $tname;?>" /> 
                                            <input type="hidden" class="form-control" id="user" name="user" required value="<?php echo $name;?>"  /> 
											 ...
											 <input type="hidden" class="form-control" id="state" name="state" required value="<?php echo $state;?>"  /> 
                                        </div>
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="tprice" name="tprice" required placeholder="Tool Price" value="<?php echo $tprice;?>" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="addtool.php"><button class="btn btn-danger" type="button" name="button" id="Close">
