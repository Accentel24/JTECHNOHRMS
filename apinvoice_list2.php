...
<div class="row">
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                     ...
                                     AP Invoice Download List
                                       ...
                                       <!-- <div class="col-sm-12"><a href="addklinvoice.php"><button class="btn btn-primary btn-xs">Add New Invoice </button></a></div>-->
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search   " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_rasise_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div style="overflow-x:auto;">
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="SELECT * FROM qot_bill where status='payment pending'  and quet_num like  '%$bsearch%'  ";
											} else {
											    
											      if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling')){
											    
													 $y="SELECT * FROM qot_bill where    inv_num!=''   ";
											      }else{
											         $y="SELECT * FROM qot_bill where status='payment pending' and inv_num!='' and user='$tsadmin'  ";
											    }
...
echo date('d-m-Y', strtotime($d)); }?></td>
												...
												<th><?php echo $rs1['user']; ?></th>		  
                                                        <td class="hidden-480">
                                                             ...
                                                             <a href="apinvoicedownload.php?id=<?php echo $q; ?>&id1=<?php echo $rs1['id'];?>">
                                                        <img src="images/download.png" height="30"></a>
                                                        <?php }else{?>
...
echo "<li><a href='apinvoice_list2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='apinvoice_list2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
