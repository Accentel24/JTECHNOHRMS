...
<div class="row">
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search By Quotation Name No  " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_appp_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                   ...
                                   <div style="overflow-x:auto;">     
											...
											$ssq1="select * from qot_bill where status='Un Paid' ";
													  } else {
													       if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling')){
													           $ssq1="select * from qot_bill where status='Un Paid' ";
													      }else{
													           $ssq1="select * from qot_bill where status='Un Paid' and user='$tsname' ";
													      }
                                                   ...
                                                   <td>
                                                       ...
                                                       ?>
                                                        ...
                                                        <td class="hidden-480">
                                                            ...
                                                            <a href="edit_req_bill3.php?id=<?php echo $q; ?>&id1=<?php echo $net;?>&q=<?php echo $q?>">
                                                        <img src="images/edit.gif"></a>														<?php }else{ ?>
														...
														<?php }?>
                                                       	...
                                                       	<td>
														    ...
														    $tp=mysqli_query($link,"select file from qot_bill where id='$tgid'") or die(mysqli_error($link));
														...
														<?php if(($tsname=='admin')){ ?>
														    <td>
														         <a href="apupload_req_bill.php?id=<?php echo $rs1['id']; ?>">
