...
$objPHPExcel->getActiveSheet()->mergeCells('A1:Q1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'TELANAGA TO BE RAISE  QUOTATION LIST');
...
header('Content-Disposition: attachment;filename="tgraiseinvoice"'.$date.'".xlsx"'); //tell browser what's the file name
