...
<div class="row">
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search By Quotation Name No  " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_aprsi_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                   ...
                                   <div style="overflow-x:auto;">     
											...
											$ssq1="select * from qot_bill where status='RUn Paid' ";
													  } else {
													       if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling')){
													           $ssq1="select * from qot_bill where status='RUn Paid' ";
													      }else{
													           $ssq1="select * from qot_bill where status='RUn Paid' and user='$tsname' ";
													      }
                                                   ...
                                                   <td>
                                                       ...
                                                       ?>
                                                        ...
                                                        <td class="hidden-480">
                                                            ...
                                                            <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='apbilling') ){ ?>
                                                            <a href="edit_req_ubill3.php?id=<?php echo $q; ?>&id1=<?php echo $rid;?>&q=<?php echo $qtno?>">
...
echo "<li><a href='bill_list31.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='bill_list31.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
