  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
	...
	$iname5 = ($iname5);
	 ...
	 $iname5 = ($img3);
										 ...
										 $yt=	"update  qot_bill set quet_num='$qt_no',bill_date='$bill_date',
			...
			print "self.location='bill_list2.php';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="bill_list2.php"><button class="btn btn-danger" type="button" name="button" id="Close">
