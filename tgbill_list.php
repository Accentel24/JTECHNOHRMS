               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                         ...
                                         <div style="overflow-x:auto;">
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="SELECT distinct quet_num,state,transfer_date FROM `tgrequest_amnt`  where status='Amount Transferred' and bill_status='' and  quet_num like  '%$bsearch%'  ";
											} else {
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='tgbilling') ){
											         ...
											         $y="SELECT distinct quet_num,user FROM `tgrequest_amnt` where  status='Amount Transferred'  and bill_status=''   and user='$tsname'  or docr_status='Cancel'  ";
											    }
