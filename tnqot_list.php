...
<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_tnqot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_tn_excel.php" class="btn btn-primary btn-xs">XL Download</a></b></div>
...
$start_from = ($page-1) * $results_per_page;
											...
											(('$status' <> ' ' and locate('$status', a.status) <> 0) or ('$status' = ' '  and 1 = 1) ) and a.store_code=b.store_code";
													 ...
													 $y="SELECT * FROM ".$datatable."   ORDER BY quet_num desc LIMIT $start_from, ".$results_per_page;
...
<!--<td class="center">
                                                      ...
                                                      $ro=$ro+$tb;
                                                        ...
                                                        $qc=mysqli_query($link,"select status from klqot_bill where quet_num='$quetnumc'");
                                                ...
                                                if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='sumanthpotluri')){ ?>
                                                         <a href="edit_tnqot.php?id=<?php echo $rs1['id']; ?>">
                                          ...
                                          <?php }
                                                ...
                                                if($tsname=='admin'){ ?>
                                                        ...
                                                        <a href="tneditrono_qot.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
													...
													<?php }      ?> 
														 <td class="hidden-480"><a onclick="return confirm('Are you sure you want to send the Email?');" href="tnemail.php?id=<?php echo $rs1['id'];?>&name1=<?php echo $r1['coordinator'];?>&name2=<?php echo $r1['superwisor'];?>"
												   class="">
												   ...
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                         ...
                                                         <td class="hidden-480"><a href="tnqut_excel.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                        <td class="hidden-480"><a href="tnqut_excel_bill.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                     <td class="hidden-480"><a href="tnqut_excel_mis.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                        <td class="hidden-480">
                                                       <a href="tnqot_pdf.php?id=<?php echo $rs1['id'];?>"
												   class="" target="_blank"><img src="images/pdf_icon.gif" width="30" height="30"></a>
...
echo "<li><a href='tnqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='tnqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
