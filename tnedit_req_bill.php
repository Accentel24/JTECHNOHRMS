...
<div class="row">
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										//}
                                        	...
                                        	$iname1 = ($iname1);
                                        	 ...
                                        	 $iname1 = ($img1);
												...
												$sq=mysqli_query($link,"update  tnrequest_amnt set bill_status='payment pending',req='$req',note='$note',docr_status='' where quet_num='$qt_no'");
												...
												$s=mysqli_query($link,"update add_tnqot set
												bill_rec_date='$bill_date',invoice_no='$inv_no',invoice_date='$inv_date',inv_sub_date='$inv_sub_date',invoice_status='$st',status='To Be Raise Invoice' where quet_num='$qt_no'");
												    	...
												    	$sq=mysqli_query($link,"update  tnrequest_amnt set bill_status='payment pending',req='$req',note='$note',docr_status='',not_file='$iname1' where quet_num='$qt_no'");
											//	$sq=mysqli_query($link,"insert into tnqot_bill (quet_num,bill_date,inv_num,inv_date,note,inv_sub_date,status,state,user)
											//	values('$qt_no','$bill_date','$inv_no','$inv_date','$note','$inv_sub_date','payment pending','$state','$name')");
			...
			print "self.location='tnbill_list.php';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tnbill_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">
