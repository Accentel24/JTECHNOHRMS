...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    TN To be raised Invoice List
                                        ...
                                        <div class="col-sm-12"><a href="addtninvoice.php"><button class="btn btn-primary btn-xs">Add New Invoice </button></a></div>
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search   " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_tnrasise_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div style="overflow-x:auto;">
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="SELECT * FROM tnqot_bill where status='payment pending'  and quet_num like  '%$bsearch%'  ";
											} else {
                                            ...
                                            $df=$diff->format("%a");
                                                if($df > 7){
													...
													$ssq=mysqli_query($link,"select * from tnrequest_amnt where quet_num='$q'");
...
<!--<td class="center">
													  ...
													  $ssq1=mysqli_query($link,"select * from add_tnqot where quet_num='$q'");
...
echo date('d-m-Y', strtotime($d)); }?></td>
												...
												<th><?php echo $rs1['user']; ?></th>		  
                                                        <td class="hidden-480">
                                                             ...
                                                             <a href="tnedit_req_bill2.php?id=<?php echo $q; ?>&id1=<?php echo $rs1['id'];?>">
                                                        <img src="images/edit.gif"></a>
                                                        
                                                        <a href="tnraise_delete.php?id=<?php echo $rs1['id'];?>">
...
echo "<li><a href='tnbill_list2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='tnbill_list2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
