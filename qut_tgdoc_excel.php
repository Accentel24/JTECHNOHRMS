...
$objPHPExcel->getActiveSheet()->mergeCells('A1:R1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'TELANGANA DOCUMENT REQUIRED LIST');
...
while($row	=	$result->fetch_assoc()){
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount, mb_strtoupper($row1['ro_date'],'UTF-8'));
...
header('Content-Disposition: attachment;filename="tgdocument"'.$dt.'".xlsx"'); //tell browser what's the file name
