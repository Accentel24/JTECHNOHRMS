...
include'dbfiles/uqry_cattool.php';
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
							...
							<li>
                                ...
                                <a href="addtool.php">Tool Category Details</a>
                            </li>

                            <li>
                                <a href="edit_tool.php">Edit Tool  Category Details</a>
                            </li>
 ...
 <?php
                      $id=$_REQUEST['id'];
                      $m=mysqli_query($link,"select * from cattool where id='$id'") or die(mysqli_error($link));
                            ...
                            <div class="col-xs-12">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">Edit Tool  Category Details</h3>
								</div>
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
								   ...
								   <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="tcname" name="tcname" required placeholder="Name of the Tool Category" value="<?php echo $tcname;?>" /> 
