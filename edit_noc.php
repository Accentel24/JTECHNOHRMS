  ...
  <input type="hidden" name="ses" value="<?php echo $name;?>">
											...
											<tr>
											    ...
											    <td align="right">Employee ID</td>
											     <td><input type="text" readonly value=""  readonly required name="empid" id="empid" class="form-control" onclick="window.open('emps_popup.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')" readonly="readonly"  required ></td>
                                              ...
                                              <tr>
                                        <td align="right">DOJ</td><td>
										<input type="text" required name="DOJ" readonly id="DOJ" class="form-control"></td>
                                        ...
                                        <td>
										<textarea  name="reason"  id="reason" class="form-control" rows="2" cols="5"></textarea></td>
                                        ...
                                        <div>
                                            ...
                                            <table id="dynamic-table1" class="table table-striped table-bordered table-hover" style="font-size:16px">
                                             ...
                                             <tr><td>2</td>
                                              ...
                                              <td>
										  <input type="text" name="uniform_rv" id="uniform_rv"  placeholder="if Yes"  class="form-control"></td>
                                              </tr>
                                              <tr><td>4</td>
                                              ...
                                              <td>
										  <input type="text" name="idcard_rv" id="idcard_rv"  placeholder="if Yes"   class="form-control"></td>
                                              </tr>
                                              ...
                                              <td>
										  <input type="text" name="shoes_rv" id="shoes_rv"   placeholder="if Yes"  class="form-control"></td>
                                              </tr>
                                                 <tr><td>6</td>
                                              ...
                                              <td>
										  <input type="text" name="tools_rv" id="tools_rv" placeholder="if Yes"  class="form-control"></td>
                                              </tr>
                                                 <tr><td>7</td>
                                              ...
                                              <td>
										  <input type="text" name="sal_rv" id="sal_rv"   placeholder="if Yes"  class="form-control"></td>
                                              </tr>
                                              ...
                                              <td>
										  <input type="text" name="wire_rv" id="wire_rv"  placeholder="if Yes"  class="form-control"></td>
                                              </tr>
                                              ...
                                              <td>
										  <input type="text" name="other_rv" id="other_rv"  placeholder="if Yes"  class="form-control"></td>
                                              </tr>
                                        ...
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="noclist.php"><button class="btn btn-danger" type="button" name="button" id="Close">
