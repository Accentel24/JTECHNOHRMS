...
srt=1;
//alert(id);
var adv=document.getElementById('adv_amnt'+id).value;
//alert(adv);
if(adv > 0){
   if(id==""){
       document.getElementById("ac_det1").setAttribute("required")='true';
      	//gst.attributes.required = "required";
   } else if(id=="1"){
        document.getElementById('ac_det2').required='true';
   }else{
        document.getElementById('ac_det3').required='true';
   }
...
<div class="row">
 ...
 <form name="frm" method="post" action="wtsqot_suc.php" enctype="multipart/form-data">
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                            <table class="table table-striped table-bordered table-hover">
											<tr><th colspn="3"><a onclick="window.open('ac_det.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" >Add Items</a></th></tr>
 ...
 <th><input id="ac_det1"  <?php if($r['adv_amnt']!='0.00'){ echo 'readonly';}else{ echo ''; } ?> class="form-control" name="ac_det1" value="<?php echo $str=$r['ac_det1'];?>"  onkeyup='s2(1)'><div id='suggesstion-box1'></div>
	...
	<input id="ac_det2"  class="form-control" name="ac_det2" <?php if($r['adv_amnt1']!='0.00'){ echo 'readonly';}else{ echo ''; } ?> value="<?php echo $str=$r['ac_det2'];?>"  
	onkeyup='s2(2)'><div id='suggesstion-box2'></div></td>
