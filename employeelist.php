                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <!--<td class="hidden-480" style="text-align:center;"><a href="employeepdf1.php?id=<?php echo $t1['empid']; ?>"><img src="images/pdf_icon.gif" ></a>&nbsp;&nbsp;</td>



                                                    <td class="hidden-480" style="text-align:center;"><a href="employeepdf2.php?id=<?php echo $t1['empid']; ?>"><img src="images/pdf_icon.gif"></a>&nbsp;&nbsp;</td>



                                                    <td class="hidden-480" style="text-align:center;"><a href="formqpdf.php?id=<?php echo $t1['empid']; ?>"><img src="images/pdf_icon.gif"></a>&nbsp;&nbsp;</td>



                                                    <td class="hidden-480" style="text-align:center;"><a href="docpdf.php?id=<?php echo $t1['empid']; ?>"><img src="images/pdf_icon.gif"></a>&nbsp;&nbsp;</td>
                                                    
                                                    <td class="hidden-480" style="text-align:center;"><a href="esipdf.php?id=<?php echo $t1['empid']; ?>"><img src="images/pdf_icon.gif"></a>&nbsp;&nbsp;</td>


                                                     <td class="" style="text-align:center;"><a href="emp_xl.php?id=<?php echo $t1['empid']; ?>"> <img src="images/xl.jpg" width="20" height="20"></a>&nbsp;&nbsp;</td>-->
