...
include 'PHPExcel-1.8/Classes/PHPExcel/Writer/Excel2007.php';
 $name=$_GET['user'];
//$datatable="add_klqot";
if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') or ($name=='sumanthpotluri') or ($name=='Muhammed Bafakhi') ){
...
$objPHPExcel->getActiveSheet()->mergeCells('A1:L1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'KERALA  QUOTATION  GST FILES LIST');
...
while($row	=	$result->fetch_assoc()){
	...
	$r="select * from add_klqot where quet_num='$q'";
...
header('Content-Disposition: attachment;filename="klgstlist.xlsx"'); //tell browser what's the file name
