...
foreach($array as $value)
{
    ...
    $data=explode(":",$value);
       ...
       $id=$data[0];
				 ...
				 if($id!=''){
						$sq=mysqli_query($link,"select * from tgrequest_amnt where id='$id'");
  ...
  <input type="hidden" name="ses" value="<?php echo $name;?>">
									...
									<?php $idd=$r1['id'];?>
										...
										if(isset($_POST['update'])){
											...
											$sq=mysqli_query($link,"update add_tgqot set req_amnt_settled='$amnt',status='Document Required' where quet_num='$qt_no'");
											
											
											$ssq=mysqli_query($link,"update tgrequest_amnt set transfer='$transfer',transfer_date='$transfer_date',status='Amount Transferred' where id='$id'");
											
											print "<script>";
			print "alert('Amount Transferred Successfully');";
			print "self.location='tgreq_list1.php';";
			print "</script>";
										}?>
