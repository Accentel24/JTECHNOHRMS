...
<div class="row">
             ...
             <div class="col-sm-2"><b><a href="qut_klgst_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
											...
											if(isset($_POST['bsearch'])){
											    ...
											    $y="select * from klrequest_amnt where gsttype='With GST'";
							                	}else { 
							                	    
							                	    if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') or ($tsname=='sumanthpotluri')){
												 $y="select * from klrequest_amnt where gsttype='With GST'    ";
							                	    }else{
							                	         $y="select * from klrequest_amnt where gsttype='With GST' and user='$tsname'    ";
							                	    }
											...
											while($rs1=mysqli_fetch_array($t)){
												$q=$rs1['quet_num'];
												//$ramtn
												$r=mysqli_query($link,"select * from add_klqot where quet_num='$q'") or die(mysqli_error($link));
												...
												$store_code=$r1['store_code'];
												    ...
												    <td><?php echo $rr=$rs1['req_amnt']+$rs1['gstamt']; ?></td>
                                                       ...
                                                       <td class="hidden-480"><?php echo $rs1['ac_det'] ?>
                                                        ...
                                                        <td class="hidden-480">
                                                           <?php  if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') or ($tsname=='sumanthpotluri') ){ ?>
                                                            <a href="gfile_edit.php?id=<?php echo $rs1['id']; ?>">
                                                     ...
                                                     <?php   }
														...
														<td class="hidden-480">
														   <?php   if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') or ($tsname=='sumanthpotluri')){ ?>
														    <a href="gfile_view.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
