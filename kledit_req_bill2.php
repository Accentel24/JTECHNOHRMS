...
<style>
	...
	$.ajax({          
        	type: "GET",
        	url: "getklftypedescriptionauto.php",
...
<div class="row">
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										<input id="ftype1" type="text" class="form-control" required name="ftype" onkeyup='s3(1)' >
	...
	$iname5 = ($iname5);
	 ...
	 $iname5 = ($img3);
												...
												$sq=mysqli_query($link,"update  klqot_bill set quet_num='$qt_no',bill_date='$bill_date',
											...
											if($state=='KL'){
												...
												bill_rec_date='$bill_date',invoice_no='$inv_no',invoice_date='$inv_date',inv_sub_date='$inv_sub_date',invoice_status='$st',status='kledit_req_bill2' where quet_num='$qt_no'");
											} 
											
											print "<script>";
			print "alert('Invoice Sucessfully Updated');";
			print "self.location='klbill_list2.php';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="klbill_list2.php"><button class="btn btn-danger" type="button" name="button" id="Close">
