                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <form name="frm" method="post" action="" enctype="multipart/form-data">
                      <?php
                      $empquery = mysqli_query($link, "select emp_name,DOJ,designation,employeeid from emp where employeeid='$emploid'");
                      ...
                      <table class="table table-striped table-bordered table-hover">
                        <tr>
                          ...
                          <td><input type="text" readonly value="<?php echo $emprow1['employeeid']; ?>" readonly required name="empid" id="empid" class="form-control" readonly="readonly" required></td>
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="designation" value="<?php echo $emprow1['designation']; ?>" id="designation" readonly required class="form-control">
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <textarea name="reason" id="reason" class="form-control" rows="2" cols="5"></textarea>
                          </td>
                          ...
                          <table id="dynamic-table1" class="table table-striped table-bordered table-hover" style="font-size:16px">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td><input type="radio" id="resign" name="resign" value="Yes"> <label for="resign">Yes</label>
                                  <input type="radio" id="resign" name="resign" value="No"> <label for="resign">No</label>
                                </td>
                              ...
                              <tr>
                                ...
                                <td><input type="radio" id="np" name="np" value="Yes"> <label for="np">Yes</label>
                                  <input type="radio" id="np" name="np" value="No"> <label for="np">No</label>
                                </td>
                              ...
                              <tr>
                                ...
                                <td> <input type="text" name="sup_fb" id="sup_fb" required class="form-control"></td>
                              ...
                              <tr>
                                ...
                                <td><input type="radio" id="sal_adv" name="sal_adv" value="Yes"> <label for="sal_adv">Yes</label>
                                  <input type="radio" id="sal_adv" name="sal_adv" value="No"> <label for="sal_adv">No</label>
                                </td>
                                <td>
                                  <input type="text" name="sal_rv" id="sal_rv" placeholder="if Yes" class="form-control">
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td><input type="radio" id="wire_certi" name="wire_certi" value="Yes"> <label for="wire_certi">Yes</label>
                                  <input type="radio" id="wire_certi" name="wire_certi" value="No"> <label for="wire_certi">No</label>
                                </td>
                                <td>
                                  <input type="text" name="wire_rv" id="wire_rv" placeholder="if Yes" class="form-control">
                                </td>
                              </tr>
                              <?php
                              $toolquery = mysqli_query($link, "select * from employeetoollist where employeeid='$emploid'");
                              $id = 6;
                              $bid = 0;
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td><input type="radio" id="tool_ret<?php echo $bid; ?>" name="tool_ret<?php echo $bid; ?>" value="Yes"> <label for="tool_ret<?php echo $bid; ?>[]">Yes</label>
                                    <input type="radio" id="tool_ret<?php echo $bid; ?>" name="tool_ret<?php echo $bid; ?>" value="No"> <label for="tool_ret<?php echo $bid; ?>[]">No</label>
                                  </td>
                                  <td>
                                    <input type="number" class="due" name="tool_rv[]" id="tool_rv<?php echo $id; ?>" onkeyup='qvalue(<?php echo $id ?>)' placeholder="if Yes" class="form-control">
                                  </td>
                                </tr>
                              <?php
                                $id++;
                              ...
                              <tr>
                                ...
                                <td>
                                  <input type="number" name="toolsdue" id="toolsdue" readonly class="form-control">
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td><input type="radio" id="other" name="other" value="Yes"> <label for="other">Yes</label>
                                  <input type="radio" id="other" name="other" value="No"> <label for="other">No</label>
                                </td>
                                <td>
                                  <input type="text" name="other_rv" id="other_rv" placeholder="if Yes" class="form-control">
                                </td>
                              </tr>
