...
?>
  ...
  <script>
    function getqty(str, ivalue) {
      ...
      xmlhttp.open("GET", "getavblqty.php?state=<?php echo $state ?>&q=" + str, true);
      xmlhttp.send();
    }
    ...
    <div class="main-container ace-save-state" id="main-container">
              ...
              <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <form name="frm" method="post" action="insert_assign_tools.php" enctype="multipart/form-data">
                      ...
                      <table class="table table-striped table-bordered table-hover">
                        <tr>
                          ...
                          <td><input type="text" readonly value="" readonly required name="empid" id="empid" class="form-control" onclick="window.open('employee_popup.php?state=<?php echo $state ?>','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')" readonly="readonly" required></td>
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" required name="state" readonly id="state" class="form-control">
                          </td>
                          <td align="right"> Designation</td>
                          <td>
                            <input type="text" name="designation" id="designation" readonly required class="form-control">
                      ...
                      <div>
                        ...
                        <div class="table-responsive">
                          <table id="dynamic-table1" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                              ...
                              $sql = "select distinct tname from tool where state = '$state'";  // Query to collect records
                              $r1 = mysqli_query($link, $sql) or die(mysqli_error());
                              $toolid = 0;
                              while ($row = mysqli_fetch_array($r1)) {
                                $toolid++;
                                $toolname = $row['tname'];
                                $toolphrsql = "SELECT sum(qty) as fullqty  FROM tool_phr_master WHERE toolname = '$toolname' and state = '$state'";
                                $toolphrsqlresult = mysqli_query($link, $toolphrsql);

                                while ($toolphrrow = mysqli_fetch_array($toolphrsqlresult)) {

                                  $fullqty = $toolphrrow['fullqty'];
                                }

                                $employeetoollistsql = "SELECT sum(qty) as usedqty, sum(due) as duee FROM employeetoollist WHERE toolname = '$toolname' and state = '$state'";
                                $employeetoollistsqlresult = mysqli_query($link, $employeetoollistsql);


                                while ($employeetoollistrow = mysqli_fetch_array($employeetoollistsqlresult)) {

                                  $usedqty = $employeetoollistrow['usedqty'];
                                  $duee = $employeetoollistrow['duee'];
                                }
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td><input data-row='<?php echo $toolid ?>' type='text' readonly name='toolname[]' id='toolname<?php echo $toolid ?>' style='width:200px;' value='<?php echo $row['tname'] ?>'></td>
                                  
                                  <td> <input type='text' name='avlbqty[]' data-row='<?php echo $toolid ?>' value='<?php echo $finalqty ?>' style='width:60px;' class='txt20' readonly id='avlbqty<?php echo $toolid ?>' /></td>

                                  <td><input type='text' name='qty[]' data-row='<?php echo $toolid ?>' onkeyup='qval(this.value,<?php echo $toolid ?>)' value='' style='width:60px;' class='txt1' id='qty<?php echo $toolid ?>' /> </td>
                        ...
                        <div class="form-group">
                          <div class="col-md-offset-4 col-md-8">
                            ...
                            &nbsp; &nbsp; &nbsp;
                            <a href="assigntoollist.php"><button class="btn btn-danger" type="button" name="button" id="Close">
      ...
      <script type="text/javascript">
        ...
        $(".addmore").on('click', function() {
          ...
          data += "<td> <input type='text' name='avlbqty[]'  data-row='" + i + "'  value='' style='width:60px;' class='txt20' readonly  id='avlbqty" + i + "' /></td>";
