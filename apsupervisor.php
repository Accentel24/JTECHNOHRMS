...
$r1=mysqli_fetch_array($ssq1);
                                                    ...
                                                    <td class="hidden-480">
                                                        ...
                                                        <a href="apedit_qot.php?id=<?php echo $rs1['id']; ?>">
...
echo "<li><a href='apsupervisor.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='apsupervisor.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
