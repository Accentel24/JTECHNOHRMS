                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <form name="frm" method="post" action="apoint_suc.php" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        ...
                                                        <select id="category" name="letter_for" class="form-control">
                                                            ...
                                                            <option value="mis">MIS Executive</option>
                                                            <option value="sup">Supervisor</option>
                                                            <option value="tech">Technician</option>
                                                        </select>
                                                    </td>
                                                    <td align="right">Designation</td>
                                                    <td align="left"><input type="text" value="" class="form-control" name="desig" id="desig"></td>
                                                </tr>

                                                <tr>
                                                    <td align="right">Date</td>
                                                    <td><input type="date" name="apdate" id="apdate" value="<?php echo date('Y-m-d'); ?>" class="form-control"></td>
                                                </tr>
                                                <tr>

                                                    <td align="right">Name</td>
                                                    <td align="left"><input type="text" value="" class="form-control" name="name" id="name"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <input type="text" value="<?php echo $state;?>" readonly class="form-control" name="state" id="state">
                                                    </td>
                                                    <td align="right">Join Date</td>
                                                    <td><input type="date" name="join_date" id="join_date" value="<?php echo date('Y-m-d'); ?>" class="form-control"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <input type="text" value="" class="form-control" name="location" id="location">
                                                    </td>
                                                    <td align="right">Take Home Salary</td>
                                                    <td>
                                                        <input type="text" required name="sal_th" id="sal_th" class="form-control">
                                                    </td>
                                                </tr>


                                                <tr>
                                                    <td align="right">Certificate Name Submited</td>
                                                    <td align="left">
                                                        <input type="text" name="cert1" id="cert1" class="form-control">
                                                    </td>
                                                    <td align="right">Certificate Name Submited</td>
                                                    <td>
                                                        <input type="text" name="cert2" id="cert2" class="form-control">
                                                    </td>
                                                </tr>
