...
<div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                        ...
                                        <div class="col-sm-12"><a href="addtginvoice.php"><button class="btn btn-primary btn-xs">Add New Invoice </button></a></div>
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search   " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_tgraise_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
                                        ...
                                        <div style="overflow-x:auto;">
                                            ...
                                            $df=$diff->format("%a");
                                                if($df > 7){
													...
													$ssq=mysqli_query($link,"select * from tgrequest_amnt where quet_num='$q'");
                                                    ...
                                                    <tr style="background-color:<?php echo $color; ?>;color:<?php echo $c1; ?>;">
													  ...
													  $ssq1=mysqli_query($link,"select * from add_tgqot where quet_num='$q'");
...
echo "<li><a href='tgbill_list2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='tgbill_list2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
