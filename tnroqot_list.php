...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_tnro_excel.php?user=<?php echo $tsname;?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
...
$start_from = ($page-1) * $results_per_page;
						...
						if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='sumanthpotluri') or ($tsname=='venkateswaran')){
...
$r1=mysqli_fetch_array($ssq1);
                                                    ...
                                                    <td class="hidden-480"><a href="tnroedit_qot.php?id=<?php echo $rs1['id']; ?>">
...
echo "<li><a href='tnroqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='tnroqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
