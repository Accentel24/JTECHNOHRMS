...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                  ...
                  <div class="col-sm-2"><b><a href="qut_tnrreqamt_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
				</div>
                                ...
                                <?php         
                                  if(isset($_POST['bsearch'])){
											...
											// $y="select * from add_qot2 where  ro_date='$date'";
												$y="select * from tnrequest_amnt where confirm!='Yes' order by id desc";
...
<!--<td class="center">
										...
										$state=$rs1['state'];
										if($state=='TN'){
										 $a="select * from add_tnqot where quet_num='$qot' and ro_date='$date'  ";
										} 
										 ...
										 <td><?php echo $i; ?></td>
												 ...
												 <td class="hidden-480"><?php echo $r1['tot_gst']; ?></td>
												  ...
												  ?></td>
                                                       ...
                                                       <td class="hidden-480"><a href="tnreq_amnt_list.php?id=<?php echo $rs1['id']; ?>&amt=<?php echo $amt;?>&st=<?php echo $state;?>" onclick="return confirm('are you sure?')">
                                                        <img src="update.png" width="16" height="16"></a></td>
                                                    <td class="hidden-480"><a href="tnedit_request.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
                                                     
                                                     <a href="tncancel_request.php?id=<?php echo $rs1['id']; ?>">
										...
										<?php } ?>
											...
											if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='sumanthpotluri') or ($tsname=='venkateswaran')){
											    	$y="select distinct quet_num,state,user from tnrequest_amnt where confirm!='Yes' order by id desc";
											}else{
											    	$y="select distinct quet_num,state,user from tnrequest_amnt where confirm!='Yes' and user='$tsname' order by id desc";
											}
...
<!--<td class="center">
                                        ...
                                        echo $tadv=$ty15['samt'];
                                                ...
                                                ?>
												    ...
												    <td class="hidden-480">
												        <?php
												             $tyy="select sum(req_amnt+gstamt) as samt from tnrequest_amnt where quet_num='$qot' and confirm='Pending'";
                                        ...
                                        echo $uy01['gsttype']."-".$gstamt."<br/>";
                                                        ...
                                                        <td class="hidden-480">
                                                            ...
                                                            <?php 
                                                             $yt="select * from tnrequest_amnt where quet_num='$qot'";
                                        ...
                                        echo $uy1['ac_det']."-".$at."(".$uy1['req_date'].")<br/>";
                                                       ...
                                                       <td class="hidden-480">
                                                         <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='sumanthpotluri') or ($tsname=='venkateswaran')){ ?>
                                                           <a href="tnreq_amnt_list.php?id=<?php echo $qot; ?>&amt=<?php echo $amt;?>&st=<?php echo $state;?>" onclick="return confirm('are you sure?')">
                                                    ...
                                                    <td class="hidden-480">
                                                        ...
                                                        <a href="tnedit_request.php?id=<?php echo $rs1['quet_num']; ?>">
                                                        <img src="images/edit.gif"></a>
                                                        
                                                        <a href="tncancel_request.php?id=<?php echo $rs1['quet_num']; ?>">
                                                        <img src="images/Icon_Delete.png"></a>
                                                        <?php }else{ ?>
