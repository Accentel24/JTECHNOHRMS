...
<div class="row">
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										<input type="file" name="image" id="image" required class="form-control"/></td>	
                                        
                                        </tr>
										<tr><td align="right">View File</td><td align="left">
										<a href="gfiledownload.php?file=<?php echo urlencode($r['gstfile'])?>">View File</a></td>	
	...
	$iname1 = ($iname1);
	 ...
	 $iname1 = ($img1);
												...
												$sq=mysqli_query($link,"update  request_amnt set gstatus='pending',gstfile='$iname1' where id='$id'");
											
										if($sq){
												
			print "<script>";
			print "alert('Bill Sucessfully Updated');";
			print "self.location='work2.php';";
			print "</script>";
										}
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="work2.php"><button class="btn btn-danger" type="button" name="button" id="Close">
