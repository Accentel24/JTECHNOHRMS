...
<div class="row">
             ...
             <div class="col-sm-2"><b><a href="qut_gst_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
											...
											while($rs1=mysqli_fetch_array($t)){
												$q=$rs1['quet_num'];
												//$ramtn
												$r=mysqli_query($link,"select * from add_qot where quet_num='$q'") or die(mysqli_error($link));
                                                   ...
                                                   <td class="hidden-480"><?php echo $rs1['ac_det'] ?></td>
                                                        ...
                                                        <td class="hidden-480">
                                                           <?php  if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') ){ ?>
                                                            <a href="apfile_edit.php?id=<?php echo $rs1['id']; ?>">
                                                     ...
                                                     <?php   }
														...
														<td class="hidden-480">
														   <?php   if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') ){ ?>
														    <a href="apfile_view.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
...
echo "<li><a href='work2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='work2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
