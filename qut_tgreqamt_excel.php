...
$objPHPExcel->getActiveSheet()->mergeCells('A1:T1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'TELANGANA REQUEST AMOUNT LIST');
...
header('Content-Disposition: attachment;filename="tgreqamountlist.xlsx"'); //tell browser what's the file name
