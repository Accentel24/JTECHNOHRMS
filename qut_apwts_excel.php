...
$objPHPExcel->getActiveSheet()->mergeCells('A1:R1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'ANDHRA PRADESH WORK TO STARTED QUOTATION LIST');
...
header('Content-Disposition: attachment;filename="apworktobestartd.xlsx"'); //tell browser what's the file name
