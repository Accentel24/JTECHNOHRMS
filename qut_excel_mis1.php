...
.underline{
   ...
   <!-- style="width:100%;height:120px;"-->
    ...
    width: 80%;
    display: block;">JYOTHI INFRA SERVICE</b></td></tr>
		<tr >
...
<td><?php echo $a=$r['tot_base'];?></td><td><?php echo $b=$r['tot_ser'];?></td>
<td><?php echo $c=$r['tot_gst'];?> </td><td><?php echo $a+$b+$c;?></td></tr>
	...
	<tr><td colspan="1" style="width:15%">Vendor's representative</td>
	<td   style="width:10%" >
