                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-header">
                            <h1 align="center">
                              AP  Mark Not Required File View
                            </h1>
                        </div>
 ...
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										<?php echo $r['note']?></td>	
                                         ...
                                         <tr><td align="right">File View</td><td align="left">
                                             <?php if($not_file!=''){ ?>
										<a href="upload/<?php echo $not_file?>">View File</a>
										<?php }else{ ?> View File <?php } ?>
										</td>	
                                        
                                        </tr>
										<tr><td align="right">File Status</td>
										<td align="left"><select name="status" class="form-control">
									...
									<input type="hidden" name="id1" 
										...
										if(isset($_POST['update'])){
											...
											$qt_no=$_POST['qt_no'];
												...
												$sq=mysqli_query($link,"update  request_amnt set docr_status='$status' where id='$id'");
											
												$yt="update add_qot set status='Not Required'  where quet_num='$qt_no'";
if($status=="approved"){
 $k=mysqli_query($link,$yt) or die(mysqli_error($link));   
}
			...
			print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="work1.php"><button class="btn btn-danger" type="button" name="button" id="Close">
