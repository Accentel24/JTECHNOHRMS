  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										if(isset($_POST['update'])){
											...
											$remarks=$_POST['remarks'];
												...
												$sq=mysqli_query($link,"insert into klpayment
												...
												$ssq=mysqli_query($link,"update  klqot_bill set status='Paid' where inv_num='$inv_no'") or die(mysqli_error($link));
												
												$us=mysqli_query($link,"select quet_num from klqot_bill where inv_num='$inv_no'") or die(mysqli_error($link));
										$us1=mysqli_fetch_assoc($us);
										$qqno=$us1['quet_num'];
										mysqli_query($link,"update add_klqot  set status='Payment Received' where quet_num='$qqno'") or die(mysqli_error($link));
											
										
											
											print "<script>";
			print "alert('Invoice Sucessfully Updated');";
			print "self.location='klbill_list3.php';";
			print "</script>";
										}?>
