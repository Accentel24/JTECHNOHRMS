...
include'dbfiles/uqry_ac_det.php';
?>
<!DOCTYPE html>
<html lang="en">
                               ...
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off">
								   ...
								   <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="acyear" name="acyear" required placeholder="2017-18" value="<?php echo $acyear;?>" /> 
                                            <input type="hidden" class="form-control" id="user" name="user" required value="<?php echo $name;?>"  /> 
											 <input type="hidden" class="form-control" id="id1" name="id1" required value="<?php echo $id1;?>"  /> 
                                        </div>
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="no" name="no" required placeholder="Account No" value="<?php echo $ac_no;?>" /> 
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="ifsc" name="ifsc" required placeholder="IFSC" value="<?php echo $ifsc;?>" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-4 col-md-8">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="ac_det.php"><button class="btn btn-danger" type="button" name="button" id="Close">
