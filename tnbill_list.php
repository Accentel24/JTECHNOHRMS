                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">TN Document Required List</a>
                            </li>
                            <li>
...
<div class="row">
                ...
                <input type="text" class="form-control pull-right" id="myInput" onkeyup="myFunction()" name="search" placeholder="Search  ">
                  ...
                  <div class="col-sm-2"><b><a href="qut_tndoc_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div style="overflow-x:auto;">
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="SELECT distinct quet_num,state,transfer_date,user FROM `tnrequest_amnt`  where status='Amount Transferred' and bill_status='' and  quet_num like  '%$bsearch%'  ";
											} else {
											    
											    
											    
													  //$y="SELECT distinct quet_num,state,transfer_date FROM `tnrequest_amnt` where  status='Amount Transferred' and bill_status=''     ";
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='tnbilling') or ($tsname=='sumanthpotluri') or ($tsname=='venkateswaran') ){
											         $y="SELECT distinct quet_num,user FROM `tnrequest_amnt` where  status='Amount Transferred' and bill_status=''  or docr_status='Cancel'    ";
											    }else{
											         $y="SELECT distinct quet_num,user FROM `tnrequest_amnt` where  status='Amount Transferred'  and bill_status=''   and user='$tsname'  or docr_status='Cancel'  ";
											    }
											...
											while($rs1=mysqli_fetch_array($t)){
											    $ses=$rs1['user'];
											    	$qtno=$rs1['quet_num'];
											    	 $yt=mysqli_query($link,"select transfer_date from tnrequest_amnt where quet_num='$qtno'");
                                            ...
                                            $df=$diff->format("%a");
                                                if($df > 7){
													...
													$qtno=$rs1['quet_num'];
						$a="select store_code,ro_no,ro_date,falt_desc,id,tot_base,tot_ser,tot_gst,net from add_tnqot where quet_num='$qtno'";
...
<!--<td class="center">
									 ...
									 $ac=$rs1['ac_det'];
									 $a="select ac_det,approve_amnt,transfer_date from tnrequest_amnt where quet_num='$qtno' and  confirm='Yes' ";
										 ...
										 while( $r2=mysqli_fetch_array($sr1)){
											  ...
											  //$req_amnt=$r2['req_amnt'];
                                                ...
                                                //    $apamt=$apamt+$req_amnt;
                                                        ...
                                                        $a="select sum(approve_amnt) as req_amnt from tnrequest_amnt where quet_num='$qtno' and  confirm='Yes' ";
														  $sr1=mysqli_query($link,$a);
...
<?php
														...
														$a1="select transfer_date  from tnrequest_amnt where quet_num='$qtno' and  confirm='Yes' order by id desc limit 1 ";
...
echo date('d-m-Y', strtotime($d)); }?></td>
                                                        ...
                                                        <td class="hidden-480">
                                                             ...
                                                             <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='tnbilling') or ($tsname=='sumanthpotluri') or ($tsname=='venkateswaran')){ ?>
                                                            
                                                            <a href="tnedit_req_bill.php?id=<?php echo $rs1['quet_num']; ?>&id1=<?php echo $r1['id'];?>">
                                                        <img src="images/edit.gif"></a>
                                                        
                                                        <?php }else{?>
                                                        <img src="images/edit.gif">
                                                        <?php }?>
                                                         <?php if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname==$ses) or ($tsname=='sumanthpotluri') or ($tsname=='venkateswaran') ){ ?>
                                                        <a href="tnwtsedit1_qot.php?id=<?php echo $qtno; ?>">
