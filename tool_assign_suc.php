...
if(isset($_POST['submit'])){
	...
	$x="update emp set DOR ='$DOR' ,reason = '$reason',status='inactive' where employeeid='$empid'";
	echo $x;
 ...
 $state = $_GET['state'];
	  ...
	  if ($res) {
        ...
        print "self.location='reli_list.php?state=$state';";
        print "</script>";
	  }
...
if($res){
	print "<script>";
	print "alert('Sucessfully Updated');";
	print "self.location='andhrabill_list.php?state=$state';";
	print "</script>";
