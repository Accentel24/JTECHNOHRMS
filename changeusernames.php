...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="" enctype="multipart/form-data">
                                        ...
                                        <tr>
                                                 <td align="right">Quotation Num</td>
                                                 <td>
                                              <input type="text"  name="quotation" id="quotation" rows="4"  required class="form-control"/>
										 </td>
										 </tr>
                                      
										 <tr>
                                         <td align="right">User Name</td><td>
                                        <select name="luser" id="luser" required  class="form-control">
                                        <option value="">Select User Name</option>
                                        <?php
                                        $u=mysqli_query($link,"select * from admin_login") or die(mysqli_error($link));
                                        while($u1=mysqli_fetch_array($u)){ 
                                        ?>
                                        
                                        <option value="<?php echo $u1['user'] ?>"><?php echo $u1['user'] ?></option>
                                        <?php }?>
                                        </select>
                                        ...
                                        if(isset($_POST['submit'])){
                                            ...
                                            $luser=$_POST['luser'];
                                          if($state=="AP"){
                                                $t="update add_qot set ses='$luser' where quet_num='$quotation'";
                                          }else if($state=="TG"){
                                               $t="update add_tgqot set ses='$luser' where quet_num='$quotation'";
                                          }else if($state=="KL"){
                                               $t="update add_klqot set ses='$luser' where quet_num='$quotation'";
                                          }else if($state=="TN"){
                                                $t="update add_tnqot set ses='$luser' where quet_num='$quotation'";
                                          }else{
                                              $t="";
                                          }
	                                        ...
	                                        if($kl){
                                                ...
                                                print "self.location='changeusernames.php';";
                                                print "</script>";
	                                        }
