...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                     ...
                                     KL Mark Not Required Bills  List
                                        </div>
             ...
             <div class="col-sm-2"><b><a href="qut_klmark_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
											...
											if(isset($_POST['bsearch'])){
											    $y="select * from klrequest_amnt where req='Yes' and docr_status!='Cancel'  ";
											 }else { 
												 $y="select * from klrequest_amnt where req='Yes' and docr_status!='Cancel'  ";
											...
											$yu=mysqli_query($link,"select * from add_klqot where quet_num='$quet_num'") or die(mysqli_error($link));
...
<!--<td class="center">
                                                    ...
                                                    <td><?php echo $r3['superwisor']; ?> </td>
                                                     <td><?php 
                                                     $uy=mysqli_query($link,"select sum(approve_amnt) as amt from klrequest_amnt where quet_num='$quet_num'") or die(mysqli_error($link));
                                                     ...
                                                     <th><?php echo $rs1['note']; ?></th>
                                                        ...
                                                        <td><a href="kldcrfile_view.php?id=<?php echo $rs1['id'] ?>">View Fiie</a></td>
...
echo "<li><a href='klwork2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='klwork2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
