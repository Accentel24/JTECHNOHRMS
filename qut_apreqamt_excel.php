...
while($row	=	$result->fetch_assoc()){
	...
	$tyy="select sum(req_amnt+gstamt) as rsamt from request_amnt where quet_num='$qot' and confirm='Pending'";
	...
	$yt1="select gsttype,gstamt from request_amnt where quet_num='$qot'";
	...
	$yt="select req_amnt,gstamt,ac_det,req_date from request_amnt where quet_num='$qot'";
...
header('Content-Disposition: attachment;filename="apreqamountlist.xlsx"'); //tell browser what's the file name
