...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_apro_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
...
$r1=mysqli_fetch_array($ssq1);
                                                    ...
                                                    <td class="hidden-480"><a href="roedit_qot.php?id=<?php echo $rs1['id']; ?>">
                                                   ...
                                                   <a onclick="window.open('qut_print.php?id=<?php echo $rs1['id'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                     ...
                                                     <td class="hidden-480"><a href="qut_excel_mis.php?id=<?php echo $rs1['id']; ?>">
                                                       ...
                                                       <a href="qot_pdf.php?id=<?php echo $rs1['id'];?>"
...
echo "<li><a href='roqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='roqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
