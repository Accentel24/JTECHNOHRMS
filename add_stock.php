...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="">
										 ...
										 <input type="text" name="state" id="state" required class="form-control"></td>
                                        ...
                                        <input type="text" name="format_type" id="format_type" required class="form-control">
                                        
                                       </td>
                                        <td align="right">Store Code</td><td>
                                        <input type="text" name="store_code" id="store_code" required class="form-control">
                                        ...
                                        <input type="text" name="store_name" id="store_name" required class="form-control">
										...
										<?php $sq=mysqli_query($link,"select * from compnay order by name");
                                       ...
                                       <!-- <input type="text" name="comp_name" id="comp_name" required class="form-control">
                                        ...
                                        <input type="text" name="costcenter" id="costcenter" required class="form-control">
                                        ...
                                        <!--<input type="text" name="cordinator" id="cordinator"  class="form-control">-->
										<select name="cordinator" class="form-control">
										<option value="">Select Coordinator</option>
										<?php $sq=mysqli_query($link,"select * from coordination order by name");
										while($r=mysqli_fetch_array($sq)){?>
										<option value="<?php echo $r['name'];?>"><?php echo $r['name'];?></option>
										<?php }?>
										</select>
                                        ...
                                        <!--<input type="text" name="afm" id="afm" required class="form-control">-->
										<select name="afm" class="form-control" required>
										<option value="">Select AFM</option>
										<?php $sq=mysqli_query($link,"select * from afm order by name");
										while($r=mysqli_fetch_array($sq)){?>
										<option value="<?php echo $r['name'];?>"><?php echo $r['name'];?></option>
										<?php }?>
										</select>
                                    ...
                                    <textarea name="addr"  class="form-control" required></textarea>
										...
										<?php $sq=mysqli_query($link,"select * from super order by name");
										while($r=mysqli_fetch_array($sq)){?>
										<option value="<?php echo $r['name'];?>"><?php echo $r['name'];?></option>
										<?php }?>
										</select>
                                <!-- <input type="text" name="super" class="form-control">-->
                                        ...
                                        <input type="text" name="ship_name" id="ship_name" required class="form-control">
                                        
                                       </td>
                                        <td align="right">Ship to Party State</td><td>
                                        <input type="text" name="ship_state" id="ship_state" required class="form-control">
                                        
                                       </td>
                                      
                                        </tr><tr>
                                         <td align="right">Ship to GSTIN/UIN</td><td>
                                        <input type="text" name="ship_gst" id="ship_gst" required class="form-control">
                                        
                                       </td>
                                        <td align="right">Ship to Party Address</td><td>
                                        <textarea name="addr1"  class="form-control" required></textarea>
