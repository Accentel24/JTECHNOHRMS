                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">TN Request Amount Approve  </a>
                            </li>
                            <li>
                                <a href="tnqot_list.php"> TN Request Amount Approve </a>
                            </li>
                            <li>
 ...
 <input type="hidden" name="ids<?php echo $i; ?>" value="<?php echo $id1?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
                                       ...
                                       <td align="right">Total Request Amount</td><td align="left">
										...
										<?php } else { ?>
										<a onclick="window.open('tnqut_print1.php?id=<?php echo $idd;?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
										<img src="images/printer.png">
										
										<?php }											?></td>
										
											
                                       <td align="right">Image 1</td><td><img src="upload/<?php echo $r1['img1'];?>" onclick="window.open('tnqut_image.php?id=<?php echo $r1['img1'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                      </td>  </tr>
										
										
										<tr><td align="right">Image 2</td><td align="left">
										
										<img src="upload/<?php echo $r1['img2'];?>" onclick="window.open('tnqut_image.php?id=<?php echo $r1['img2'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                      
										</td>	
                                        <td align="right">Image 3</td><td><img src="upload/<?php echo $r1['img3'];?>" onclick="window.open('tnqut_image.php?id=<?php echo $r1['img3'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                      </td>
                                        </tr>
										...
										<button class="btn btn-info" type="submit" name="update<?php echo $i; ?>" id="submit">
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tnreq_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">
							...
							echo $dd="update tnrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt1' where id='$id'";
							$ssq=mysqli_query($link,$dd);
							
								mysqli_query($link,"update add_tnqot set status='Approved Amount' where quet_num='$qt_no'") or die(mysqli_error($link));
							print "<script>";
	...
	if(isset($_POST['update2'])){
							...
							echo $dd="update tnrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt2' where id='$id2'";
							$ssq=mysqli_query($link,$dd);
			...
			print "</script>";
							...
							echo $dd="update tnrequest_amnt set confirm='$confirm',approve_amnt='$approve_amnt3' where id='$id3'";
							$ssq=mysqli_query($link,$dd);
