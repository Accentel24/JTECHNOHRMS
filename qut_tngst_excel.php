...
$objPHPExcel->getActiveSheet()->mergeCells('A1:L1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'TAMILNADU  QUOTATION  GST FILES LIST');
...
header('Content-Disposition: attachment;filename="tngstlist.xlsx"'); //tell browser what's the file name
