                ...
                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <input type="file" name="empidcardfront"  class="form-control photo-upload" accept=".jpeg, .png, .jpg" />
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <input type="file" name="empidcardback"  class="form-control photo-upload" accept=".jpeg, .png, .jpg" />
...
<table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                                                        ...
                                                        <tr>
                                                            <td align="right">DOB</td>
                                                                <td align="left">
                                                                    <input type="date" value="<?php echo $rw["ndob"] ?>" class="form-control"  id="ndob" name="ndob" >
                                                                </td>
                                                        </tr>
