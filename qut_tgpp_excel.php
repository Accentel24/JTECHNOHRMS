...
$objPHPExcel->getActiveSheet()->mergeCells('A1:W1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'TELANGANA PAYPEMENT PENDING LIST');
...
header('Content-Disposition: attachment;filename="tgpaymentpending.xlsx"'); //tell browser what's the file name
