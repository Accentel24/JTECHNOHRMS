                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">KL Document Required List</a>
                            </li>
                            <li>
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='klbilling') or ($tsname=='sumanthpotluri')){
											...
											while($rs1=mysqli_fetch_array($t)){
											    $ses=$rs1['user'];
											    	$qtno=$rs1['quet_num'];
											    $yt=mysqli_query($link,"select transfer_date from klrequest_amnt where quet_num='$qtno'");
...
<!--<td class="center">
									 ...
									 $ac=$rs1['ac_det'];
									 $a="select ac_det,approve_amnt,transfer_date from klrequest_amnt where quet_num='$qtno' and  confirm='Yes' ";
...
<?php
														...
														$a1="select transfer_date  from klrequest_amnt where quet_num='$qtno' and  confirm='Yes' order by id desc limit 1 ";
