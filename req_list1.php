...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                  ...
                  <div class="col-sm-2"><b><a href="qut_apapvamt_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
				</div>
									...
									if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from request_amnt where  quet_num like '%$bsearch%' or ac_det like '%$bsearch%'  and confirm='Yes' and status!='Amount Transferred' group by ac_det order by id desc";
												...
												//	$y="select * from request_amnt where  confirm='Yes' and status!='Amount Transferred' group by ac_det order by id desc";
													...
													$y="select * from request_amnt where  confirm='Yes' and status!='Amount Transferred'  order by id desc";    
													}else{
													    $y="select * from request_amnt where  confirm='Yes' and status!='Amount Transferred' and user='$tsname'  order by id desc";
													}
						...
						$k=mysqli_query($link,"select * from dpr where store_code='$str_code'");
							$r3=mysqli_fetch_array($k);
												...
												<tr>
												  ...
												  $bala=$bala+$r1['bal'];
												  ?></td>
												  <td class="hidden-480"><?php echo $rs1['gsttype'];
											  ...
											  $req_amnt=$r2['req_amnt'];
                                                $apt=$apt+$req_amnt;
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['user']; ?></td>
                                                          ...
                                                          <a href="req_amnt_list1.php?id=<?php echo $rs1['id']  ?>" onclick="return confirm('are you sure?')">
                                                   ...
                                                   <?php    if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts')){ ?>  
                                                    ...
                                                    <a href="edit_request1.php?id=<?php echo $rs1['id'];?>">
													...
													?>
                                                    <tr><th align="center" colspan="10" style="text-align:right;color:red;">Total</th><td><?php echo $ro; ?></td><td><?php echo $sf; ?></td><td><?php echo $gsta; ?></td><td><?php echo $tamt; ?></td><td><?php echo $reqam; ?></td><td><?php echo $bala; ?></td><td></td><td><?php echo $ada?></td><td></td><td><?php echo $apt; ?></td><td colspan="4"></td></tr> 
