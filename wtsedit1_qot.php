...
<div class="row">
 ...
 <form name="frm" method="post" action="wtsqot1_suc.php" enctype="multipart/form-data">
  ...
  <input type="hidden" name="ses" value="<?php echo $name;?>">
									...
									<tr><th colspn="3"><a onclick="window.open('ac_det.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" >Add New Account Details </a></th></tr>		
									  ...
									  <th> <input type="text" name="adv_amnt" 
										...
										id="gst_amount"    class="form-control"  value="<?php echo $r['gst_amount'];?>" ></th>
									   ...
									   <td >
										...
										id="adv_amnt1"   class="form-control kal"   <?php if(($r['adv_amnt1']!='0.00')  or ($ystatus=='Pending')){ echo 'readonly';}else{ echo ''; } ?> value="<?php echo $r['adv_amnt1'];?>">
										<input type="hidden" name="kl2" id="kl2" value="<?php  echo $klarray[1];  ?>"/>
										</td>	
									   <td >
										<input type="text" name="gst_amount1" 
										id="gst_amount1"   class="form-control kal"  value="<?php echo $r['gst_amount1'];?>"></td>
									   ...
									   <td >
										...
										id="adv_amnt2"   class="form-control kal" <?php if(($r['adv_amnt2']!='0.00') or ($ystatus=='Pending') ){ echo 'readonly';}else{ echo ''; } ?>    value="<?php echo $r['adv_amnt2'];?>">
										<input type="hidden" name="kl3" id="kl3" value="<?php  echo $klarray[2];  ?>"/>
										</td>	
										<td >
										<input type="text" name="gst_amount2" 
										id="gst_amount2"     class="form-control"  value="<?php echo $r['gst_amount2'];?>"></td>	
									   ...
									   <td >
										...
										id="adv_amnt3"   class="form-control kal" <?php if(($r['adv_amnt3']!='0.00') or ($ystatus=='Pending') ){ echo 'readonly';}else{ echo ''; } ?>    value="<?php echo $r['adv_amnt3'];?>">
										<input type="hidden" name="kl4" id="kl4" value="<?php  echo $klarray[3];  ?>"/>
										</td>	
										<td >
										<input type="text" name="gst_amount3" 
										id="gst_amount3"     class="form-control"  value="<?php echo $r['gst_amount3'];?>"></td>	
									   ...
									   <td><input id="ac_det4"  <?php if($r['adv_amnt3']!='0.00'){ echo 'readonly';}else{ echo ''; } ?> class="form-control" name="ac_det4" value="<?php echo $str=$r['ac_det4'];?>"  onkeyup='s2(4)'><div id='suggesstion-box4'></div>
</td>
									   </tr>
									   ...
									   <tr>
									   <th>5</th>
									   	<td><select name="gst_type4" id="gst_type4" class="form-control" onChange="test4()">
									    <option value="">Select GST</option>
									   ...
									   <td >
										...
										id="adv_amnt4"   class="form-control kal" <?php if(($r['adv_amnt4']!='0.00') or ($ystatus=='Pending') ){ echo 'readonly';}else{ echo ''; } ?>    value="<?php echo $r['adv_amnt4'];?>">
										<input type="hidden" name="kl5" id="kl5" value="<?php  echo $klarray[4];  ?>"/>
										</td>	
										<td >
										<input type="text" name="gst_amount4" 
										id="gst_amount4"     class="form-control"  value="<?php echo $r['gst_amount4'];?>"></td>	
										
									   <td><input type="date" name="adv_date4" 
										id="sub_type"  class="form-control" <?php if($r['adv_amnt4']!='0.00'){  echo 'type="text"'.'readonly';}else{ echo 'type="date"'; } ?>       value="<?php if($r['adv_amnt4']!='0.00'){ echo  $r['adv_date4'];}else{ echo date('Y-m-d');}?>"></td>
									   
									   
									   <td><input id="ac_det5"  <?php if($r['adv_amnt4']!='0.00'){ echo 'readonly';}else{ echo ''; } ?> class="form-control" name="ac_det5" value="<?php echo $str=$r['ac_det5'];?>"  onkeyup='s2(5)'><div id='suggesstion-box5'></div>
</td>
									   </tr>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="wtsqot_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">
