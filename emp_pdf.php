...
<title>JYOTHI FACITLITY MANAGEMENT</title>
...
<table border='1' style="width:90%" align="center"  cellpadding="0" cellspacing='0'>
        <thead>
			...
			<img src="images/exel_logo.jpg"/></th></tr>
        </thead>
        <tfoot>
...
<td ><b>Quotation Number:</b><?php $qt= $r['empid'];echo $r['quet_num'];?></tr>
...
<tr>
	<th  colspan="14" style="text-align:right;padding-right:10px;font-size:20px;"> For Jyothi Infra Services<br/><img src="sign.jpeg" height="70"/><br/>Authorised Signatory
</th>
</tr>
      </tbody>
    </table></td></tr></table>
...
echo  "<script type=\"text/javascript\"> 
   ...
   setTimeout(\"DoTheRedirect('qot_list.php')\",parseInt(2*1000));
