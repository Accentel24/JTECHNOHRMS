  ...
  <input type="hidden" name="state" value="<?php echo $r['state'];?>">
										...
										if(isset($_POST['update'])){
											...
											$recevid_amnt=$_POST['recevid_amnt'];
												...
												$sq=mysqli_query($link,"insert into payment
												...
												$ssq=mysqli_query($link,"update  qot_bill set status='Paid' where inv_num='$inv_no'	");
												
												$us=mysqli_query($link,"select quet_num from qot_bill where inv_num='$inv_no'") or die(mysqli_error($link));
										$us1=mysqli_fetch_assoc($us);
										$qqno=$us1['quet_num'];
										mysqli_query($link,"update add_qot  set status='Payment Received' where quet_num='$qqno'") or die(mysqli_error($link));
											
										
											
											print "<script>";
			print "alert('Invoice Sucessfully Updated');";
			print "self.location='bill_list3.php';";
			print "</script>";
										}?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="bill_list3.php"><button class="btn btn-danger" type="button" name="button" id="Close">
