...
$objPHPExcel->getActiveSheet()->mergeCells('A1:R1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'TAMILNADU WORK TO BE STARTED QUOTATIONS LIST');
...
header('Content-Disposition: attachment;filename="tnworktobestartd.xlsx"'); //tell browser what's the file name
