...
$objPHPExcel->getActiveSheet()->mergeCells('A1:L1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'TELANGANA  QUOTATION  GST FILES LIST');
...
header('Content-Disposition: attachment;filename="tggstlist.xlsx"'); //tell browser what's the file name
