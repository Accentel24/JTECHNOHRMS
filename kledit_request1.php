  ...
  <input type="hidden" name="ses" value="<?php echo $name;?>">
									...
									<?php $idd=$r1['id'];?>
										...
										if(isset($_POST['update'])){
											...
											$sq=mysqli_query($link,"update add_klqot set req_amnt_settled='$amnt',status='Document Required' where quet_num='$qt_no'");
											
											
											$ssq=mysqli_query($link,"update klrequest_amnt set transfer='$transfer',transfer_date='$transfer_date',status='Amount Transferred' where id='$id'");
			...
			print "</script>";
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="klreq_list1.php"><button class="btn btn-danger" type="button" name="button" id="Close">
