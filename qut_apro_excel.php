...
$objPHPExcel->getActiveSheet()->mergeCells('A1:N1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'ANDHRA PRADESH QUOTATION LIST');
...
header('Content-Disposition: attachment;filename="aprorequired.xlsx"'); //tell browser what's the file name
