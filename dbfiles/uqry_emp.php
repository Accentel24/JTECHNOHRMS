...
if (isset($_POST['submit'])) {
 ...
 //if the form variables are not empty then update data into database
       ...
       rno='$rno',wname='$wname',nok='$nok',childname='$childname',pan='$pan',designation='$designation',uan='$uan',ESI_NO='$ESI_NO',PFNO='$PFNO',photo='$fileName15',emp_email='$emp_email',username='$username',password='$password',bname='$bname'
       ,branch='$branch',ifsc='$ifsc',accno='$accno',
       nname='$nname',nrelation='$nrelation',ndob='$ndob',namount='$namount',naddress='$naddress',esic_number='$esic_number'
       ,pensionscheme='$pensionscheme',pfscheme='$pfscheme',tshirt='$ushirt',tshtdt='$tshtdt',tsize='$shirtsize',phant='$upant',phtdt='$phtdt',psize='$pantsize',bg='$bg',stat='BLOCKED',
       sshoes='$ushoe',shoesdt='$shoesdt',ssize='$shoesize', idcard='$idcard',idcarddt='$idcarddt',licensestatus='$licensestatus',sitename='$sitename',uniform='$uniform',uniformisdate='$uniformisdate',permaddress='$permaddress',localaddress='$localaddress',refeaddress='$refeaddress'
       where empid='$id'";
