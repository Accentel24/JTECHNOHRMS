...
if (isset($_POST['submit'])) {
    ...
    $addnocquery = "UPDATE add_noc set `reason` = '$reason',`resign` = '$resign', `np` = '$np',`sup_fb` = '$sup_fb',`sal_adv`= '$sal_adv',`sal_rv` = '$sal_rv',`wire_certi` = '$wire_certi',`wire_rv` = '$wire_rv',`other` = '$other',`other_rv` = '$other_rv',`tooldue` = '$toolsdue'
 	WHERE id = '$emploid' and state = '$state'";
