...
if($rows>0){
	...
	$query1="update  admin_login set empname='$name',pwd='$pwd' where empname='$ename'";
}else{
...
//}else{
	 ...
	 $t="insert into hr_user(emp_id, menus, currentdate,auth_by) values('$empname1','$menuname',now(),'$name')"; 
