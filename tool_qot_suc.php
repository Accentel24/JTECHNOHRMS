...
if(isset($_POST['submit'])){
	...
	$state = $_POST['state'];
	  ...
	  $a="INSERT INTO `add_tool_phr`(`inv_date`, `inv_no`, `netamount`, `ses`, `supname`,`address`,`state`)
	 VALUES ('$inv_date','$inv_no','$netamount','$ses','$supname','$address','$state')";
...
$date=date('Y-m-d');
 ...
 $query = "INSERT INTO tool_phr_master ( `id1`, `toolname`, `rate`, `qty`, `baseamount`,`gstamnt`,`date`,`state`) 
	VALUES 
 ('$id1','$description','$price','$qty','$amnt','$gst_amnt','$date','$state')";
