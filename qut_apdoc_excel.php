...
$objPHPExcel->getActiveSheet()->mergeCells('A1:R1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'AP DOCUMENT REQUIRED LIST');
...
while($row	=	$result->fetch_assoc()){
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount, mb_strtoupper(date('d.m.Y',strtotime($row['ro_date'])),'UTF-8'));
...
header('Content-Disposition: attachment;filename="apdocument"'.$dt.'".xlsx"'); //tell browser what's the file name
