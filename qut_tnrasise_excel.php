...
$objPHPExcel->getActiveSheet()->SetCellValue('A'.$rowCount, mb_strtoupper($i,'UTF-8'));
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount, mb_strtoupper(date('d-m-Y',strtotime($row2['ro_date'])),'UTF-8'));
	$objPHPExcel->getActiveSheet()->SetCellValue('K'.$rowCount, mb_strtoupper($row2['falt_desc'],'UTF-8'));
		$objPHPExcel->getActiveSheet()->SetCellValue('L'.$rowCount, mb_strtoupper(date('d-m-Y',strtotime($row['bill_date'])),'UTF-8'));
